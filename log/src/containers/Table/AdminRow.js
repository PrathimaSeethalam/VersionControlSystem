...
class AdminRow extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            sum: 0,
            isAdded: false,
            products: this.props.newReleaseAdded
                ? []
                : [
                      {
                          id: 1,
    ...
    componentDidMount() {
        ...
        newArr.length > 0 &&
            this.setState({
                sum: (
                    newArr.reduce((a, b) => a + b) / this.state.products.length
                ).toFixed(2)
            });
    }
    ...
    disableSave = (x, y) => {
        ...
        //     return false;
        // }
        console.log(this.state.isError, 'this.state.isError');
                ...
                <tr className='eachRow' key={this.props.releaseIndex}>
                    ...
                    <td className='del-cell'>
                        ...
                        {/* <input
                            type='button'
                            disabled={
                                // isInvalidDate && !isDateEligible ? true : false
                                // this.disableSave(isInvalidDate, isDateEligible)
                                // this.state.isError ? true : false
                                this.state.isError
                            }
                            // disabled={true}
                        ...
                        <CustomizedButton
                            ...
                            buttonname={this.state.isEdit ? 'Save' : 'Edit'}
