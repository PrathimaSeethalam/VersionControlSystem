...
class AdminDashboard extends Component {
    ...
    handleRowDel(product) {
        ...
        this.state.releases.splice(index, 0);
        console.log(this.state.releases.splice(index, 1), 'deleted relese');
    ...
    handleProductTable(evt) {
        ...
        // console.log(releases, 'sliced releses');
        var newReleases = this.state.releases.map(function(release) {
        ...
        return (
            <div>
                ...
                <AdminTable
                    ...
                    newReleaseAdded={this.state.newReleaseAdded}
                />
            </div>
        );
    }
